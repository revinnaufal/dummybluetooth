...
import 'package:new_bluetooth/ble_widget.dart';
        ...
        body: RefreshIndicator(
          onRefresh: () {
            ...
            return Future.delayed(
                Duration(milliseconds: 15000)); // show refresh icon breifly
          },
                ...
                StreamBuilder<List<BluetoothDevice>>(
                  ...
                  builder: (c, snapshot) => Column(
                    children: (snapshot.data ?? [])
                        .map((d) => ListTile(
                              title: Text("${d.localName} ASDASD"),
                              subtitle:
                                  Text("${d.remoteId.toString()} asdasdasd"),
...
class DeviceScreen extends StatelessWidget {
  ...
  // AdvertisementData x =AdvertisementData(localName: localName, txPowerLevel: txPowerLevel, connectable: connectable, manufacturerData: manufacturerData, serviceData: serviceData, serviceUuids: serviceUuids);
